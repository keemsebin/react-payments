    ...
    CardInputLayout,
    {
      ...
      children: /* @__PURE__ */ jsx$1(
        Flex,
        {
          ...
          margin-bottom: 20px;
        `,
          children: /* @__PURE__ */ jsx$1(Select, { selectedOptions: brandFormData.brand ?? "전체", children: categories.map((category) => /* @__PURE__ */ jsx$1(
            Select.Option,
            {
              option: category,
...
const CardForm = () => {
  ...
  return /* @__PURE__ */ jsxs(CardFormProvider, { children: [
